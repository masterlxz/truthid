...
- **Débitos resolvidos**: #8 (UX/layout), #9 (stepper visual Ledger).
- **Próximo passo**: débito #10 (mostrar endereços Ethereum ao lado de cada Account no seletor de conta), #12 (desabilitar auto-reconexão wagmi), ou #13 (site de docs com Session Registration).
