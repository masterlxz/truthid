...
#### Bug real #2 — `CreateIdentity.tsx` sem retry após falha de nonce (débito #44, não corrigido)
...
#### Configuração do Kubo — CORS ausente do guia do próprio app (débito #46, não corrigido)
