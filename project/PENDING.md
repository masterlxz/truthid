...
> 
> Última atualização: 2026-08-19 (Sessão 213: P57 fechado — landing pública com instaladores nos 4 idiomas, virou a raiz do site; achados reais: `.zip` da extensão faltava no release, nome errado do `.dmg` do macOS, `basePath` faltando nos links internos)
