  ...
  return (
    <div>
      ...
      <p className="muted" style={{ marginBottom: "1.25rem" }}>
        Documentos anexados às entradas são enviados para todos os providers configurados
        ao clicar "Enviar" (o blob principal do vault agora vai pro Arweave, ver acima).
        Recomendado: ao menos um provider <strong>kubo</strong> (nó local, sem custo) e um{" "}
        <strong>psa</strong> (cloud, para redundância).
      </p>
 ...
 * o blob principal do vault agora publica no Arweave em vez do IPFS, e isso
 * exige uma wallet local financiada com AR. Sem UI nenhuma pra isso, "Enviar"
 * simplesmente falhava com o erro do Rust (`nenhuma wallet Arweave
 * configurada...`) sem nenhum jeito de resolver de dentro do app. Componente
 * próprio (não reaproveita o load/save de `PinningProvider` acima — fonte de
 * dados totalmente diferente, comandos Tauri específicos do Arweave).
 */
function ArweaveWalletSection() {
  ...
  return (
    <div className="card" style={{ marginBottom: "1.5rem" }}>
      ...
      <p className="muted" style={{ marginBottom: "1.25rem" }}>
        O blob principal do vault é publicado no Arweave — precisa de uma wallet local
        financiada com AR. (Documentos anexados continuam nos providers de pinning acima.)
      </p>
