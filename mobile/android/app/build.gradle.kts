...
android {
    ...
    defaultConfig {
        applicationId = "com.truthid.truthid_mobile"
    ...
    buildTypes {
        release {
            // Usa a keystore de release se KEYSTORE_PATH estiver definido (CI),
            // senão cai no debug key (builds locais — funciona mas não atualiza OTA).
